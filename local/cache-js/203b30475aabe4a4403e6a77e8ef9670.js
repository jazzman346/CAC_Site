...
$(palette)
.after('<div class="colorpicker"><div class="colorpicker_close" title="Close palette">&nbsp;×&nbsp;</div><div class="colorpicker_bar">Palette</div><div id="colorpicker"></div></div>');
$.farbtastic('#colorpicker',palette).updateDisplay();
$(".colorpicker").empty().remove();
$(this).focus(function(){
$(".colorpicker").empty().remove();
$(palette)
.after('<div id="bugIE7"></div><div class="colorpicker"><div class="colorpicker_close" title="Close palette">&nbsp;×&nbsp;</div><div class="colorpicker_bar">Palette</div><div id="colorpicker"></div></div>');
