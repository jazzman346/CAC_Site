/* compact [
	...
	../plugins-dist/mediabox/javascript/jquery.colorbox.js?1407960352
	../plugins/auto/tinymce/v0.9.5/jscripts/tiny_mce/jquery.tinymce.js
	page=tinymce_jsconfig(objet=article)
	page=palette.js
] 59.7% */
...
script_url:"../plugins/auto/tinymce/v0.9.5/jscripts/tiny_mce/tiny_mce.js",
theme:"advanced",
skin:"o2k7",
skin_variant:"silver",
language:"fr",
directionality:"ltr",
relative_urls:false,
plugin_spip_arg_barre:"tmce_barre",
plugin_spip_special_class:"spiptmceInsert",
theme_advanced_toolbar_location:"top",
theme_advanced_toolbar_align:"left",
theme_advanced_statusbar_location:"bottom",
theme_advanced_resizing:true,
plugins:"spip,autolink,lists,pagebreak,style,layer,table,save,advhr,advimage,advlink,emotions,iespell,inlinepopups,insertdatetime,preview,media,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,template,advlist",
theme_advanced_buttons1:"bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,formatselect,fontselect,fontsizeselect",
theme_advanced_buttons2:"sub,sup,hr,blockquote,abbr,acronym,del,ins,|,bullist,numlist,|,outdent,indent,|,link,unlink,anchor,|,forecolor,backcolor",
theme_advanced_buttons3:"tablecontrols,|,charmap,image,media,template,nonbreaking,|,ltr,rtl",
theme_advanced_buttons4:"undo,redo,|,cut,copy,paste,pastetext,pasteword,|,search,replace,|,visualchars,|,attribs,removeformat,cleanup,|,insertdate,inserttime,|,code,|,fullscreen,|,spipinsert,|,spip",
theme_advanced_blockformats:"p,h3,h4,h5,h6,blockquote,dt,dd,code,samp",
content_css:"http://coeuracoeur.net/squelettes-dist/css/typo.css,http://coeuracoeur.net/squelettes-dist/css/layout.css,http://coeuracoeur.net/plugins/auto/tinymce/v0.9.5/css/tinymce_layout.css",
body_class:"page content texte spiptinymce",
body_id:"",
external_link_list_url:"http://coeuracoeur.net/spip.php?page=tinymce_json&amp;type=list_links",
external_image_list_url:"http://coeuracoeur.net/spip.php?page=tinymce_json&amp;type=list_images",
media_external_list_url:"http://coeuracoeur.net/spip.php?page=tinymce_json&amp;type=list_medias",
external_template_list_url:"http://coeuracoeur.net/spip.php?page=tinymce_json&amp;type=list_templates"
})
;
}
}
function barre_inserer(what,inst){
  tinyMCE.execCommand('mceInsertContent',false,'<span class="spiptmceInsert">'+what+'</span><br />');
}
...
$(palette)
.after('<div class="colorpicker"><div class="colorpicker_close" title="Fermer la palette">&nbsp;×&nbsp;</div><div class="colorpicker_bar">Palette</div><div id="colorpicker"></div></div>');
$.farbtastic('#colorpicker',palette).updateDisplay();
$(".colorpicker").empty().remove();
$(this).focus(function(){
$(".colorpicker").empty().remove();
$(palette)
.after('<div id="bugIE7"></div><div class="colorpicker"><div class="colorpicker_close" title="Fermer la palette">&nbsp;×&nbsp;</div><div class="colorpicker_bar">Palette</div><div id="colorpicker"></div></div>');
